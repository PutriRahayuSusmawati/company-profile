...
// DUA BAHASA
 const translations = {
    id: {
      ...
      subheadline: "Memberdayakan petani kecil dan generasi muda, menurunkan emisi, dan menciptakan nilai dari hulu ke hilir.",
      ...
      Dampak:"Dampak Kami",
      penurunan:"Penurunan emisi metana sebesar 27% melalui sistem pakan berbasis silase",
      ...
      lebih:"Lebih dari 200 petani kecil dan pemuda terlibat dalam praktik peternakan berkelanjutan",
    ...
    en: {
      ...
      subheadline: "Empowering smallholder farmers and youth, reducing emissions, and creating value from agricultural waste.",
      button: "Explore More",
      about:"About Us ",
      ...
      Dampak:"Our Impact ",
      penurunan:"27% reduction in methane emissions using silage-based feeding systems",
      peningkatan:"35% increase in sheep productivity through better nutrition and care",
      kotoran:"100% of manure is recycled into valuable organic products",
      pengurangan:"Up to 40% reduction in feed costs by using agricultural waste",
      lebih:"Over 200 smallholder farmers and youth engaged in sustainable farming",
